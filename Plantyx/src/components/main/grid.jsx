...
function Grids() {
  return (
    <div className="p-4 w-[80%] m-auto">
      <div className="flex flex-col gap-2 sm:gap-6">
        <div className="flex justify-center items-stretch gap-2 sm:gap-6 ">
          <div>
            <img
              src={frame1}
              alt="A space with green plants"
              className="w-60 h-full object-cover  sm:w-full"
            />
          </div>
          <div>
            <img
              src={frame3}
              alt="A space with green plants"
              className="w-60 object-cover h-full sm:w-full"
            />
          </div>
        </div>
        <div className="relative sm:w-full sm:m-auto">
          <img
            src={frame2}
            alt="A space with green plants"
            className=" object-cover h-60 w-full   sm:h-[80vh] sm:object-cover "
          />
          <div className="absolute  top-[10%] left-[10%]">
            <p className="font-semibold sm:text-[1.5rem] lg:text-[3rem] md:w-[60%] w-40">
              Get inspired from our Instagram
            </p>
            <p className="font-light sm:text-sm md:w-[50%] md:py-2 text-[0.8rem] w-60 py-2">
              If you use the hashtag #bloomey on Instagram well spotlight you.
            </p>
            <p className="font-semibold flex gap-4 md:text-sm text-[0.8rem]">
              Check it out{" "}
      ...
      <div className="sm:flex  sm:m-auto  sm:justify-between sm:items-center sm:pt-8">
        <p className="text-[#000000] font-semibold text-lg flex justify-center py-5 lg:text-[2.4rem] lg:leading-10 ">
          Stay update with special offers, plant-parenting tips, and more.
        </p>
        <div className=" flex justify-between items-center  border-b-2  border-[#000000] mb-2 w-full m-auto outline-none sm:m-0 ">
          <input
            type="text"
